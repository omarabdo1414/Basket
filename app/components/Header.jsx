            ...
            <header >
                ...
                <div className="head-2">
                    <ul className={`flex gap-3 ${inter.className} max-md:hidden `}>
                        <li className='text-nowrap hover:text-[#35afa0]'><a href="/about">About Us</a></li>
                        <li className='text-nowrap hover:text-[#35afa0]'><a href="#">Compare</a></li>
                        <li className='text-nowrap hover:text-[#35afa0]'><a href="#">Wishlist</a></li>
                    </ul>
