            ...
            <header >
                ...
                <div className="head-2">
                    <ul className={`flex gap-3 ${inter.className} max-md:hidden `}>
                        <li className='text-nowrap'><a href="/about">About Us</a></li>
                        <li className='text-nowrap'><a href="/compare">Compare</a></li>
                        <li className='text-nowrap hover:text-[#A]'><a href="/wishlist">Wishlist</a></li>
                    </ul>
